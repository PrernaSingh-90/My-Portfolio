      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
        ...
        >
          ...
          <p
            ...
            data-aos-delay="500"
          >
            I am a BCA Graduate with a strong passion for Frontend Development 
            and Modern UI Design. My academic background has provided me with a 
            solid foundation in computer science, which I apply to build 
            interactive and user-friendly web applications. I love turning complex
             problems into elegant digital solutions and am currently focused on 
             mastering full-stack concepts to build scalable, real-world projects.
          </p>
          <div
