      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10
         items-center'>
          ...
          <form 
          action="https://formspree.io/f/mzdkwaly"
          method='POST'
          style={{ 
            background: darkMode 
          ...
          data-aos='fade-left'>
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-3 sm:mb-4'>
              ...
              style={{ backgroundColor: darkMode ? '#374151' : '#faede3',
            ...
            name='email'
              ...
              sm:text-bas focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 
              transition-all mb-3 sm:mb-4'
               required/>
              ...
              sm:text-base focus:border-orange-500 focus:ring-2
