...
const Skills = ({ darkMode }) => {
  const skills = [
    ...
    {name: 'Firebase', icon: firebae, level: 80, 
        ...
        <div className='container px-5 py-14 mx-auto'>
          <div className='text-center mb-20' data-aos='fade-up'>
            ...
            style={{color: darkMode ? '#d1d5db' : '#4b5563'}}>
              My technical toolkit is focused on building performance-optimized 
              and scalable web solutions. I specialize in React and Tailwind CSS, 
              ensuring every project is not only visually stunning but also 
              has clean, maintainable, and industry-standard code.
            </p>
          </div>
